...
load('datasets/ORL_32x32.mat')
% Z = X'; true_labels = Y;
Z = fea'; true_labels = gnd;
%%% Z: data matrix; labels: ground truth;
...
run_KS = 1; run_SC = 0; run_TS = 1; run_GS = 1; run_LR = 1; run_LC = 1; run_MP = 1;
...
for repeat = 1:repeat_num
    ...
    if run_SC == 1
        [D,N] = size(Z); alpha = 10;  
        r = 0; affine = false; outlier = true; rho = 2;SC_type = 1;
