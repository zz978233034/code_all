...
load('./datasets/MNIST_SC.mat') %%% Z: data matrix; labels: ground truth;
true_labels = MNIST_LABEL; Z = double(MNIST_DATA); 
clear MNIST_LABEL MNIST_DATA;
...
d = 18; %%% dimension of subspaces

%% choose the running algorithms
run_KS = 1; run_SC = 0; run_TS = 1; run_GS = 1; run_LR = 0; run_LC = 0; run_MP = 1;
