...
load('datasets/ExtendedYaleB.mat')
% Z = X'; true_labels =Y;
Z = EYALEB_DATA;
true_labels = EYALEB_LABEL';
...
for repeat = 1:repeat_num
    ...
    if run_LC == 1
        sigma = 0.2; lambda = 0.5; SC_type = 0;
        tic; e_LC = ALM_noisyLRSSC(Z, K, lambda, sigma, 0, SC_type); time = toc;
